...
exports.actionsFrom = function (am) {
    return object_1.keys(am).reduce(function (ac, t) {
        return (__assign({}, ac, (_a = {}, _a[t] = exports.createAction(t), _a)));
        var _a;
    }, {});
};
...
exports.asyncMiddlewareFrom = function (am) { return function (s) { return function (n) { return function (a) { return __awaiter(_this, void 0, void 0, function () {
